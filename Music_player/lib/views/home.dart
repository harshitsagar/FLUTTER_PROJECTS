...
class Home extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
   ...
   return Scaffold(
     ...
     appBar: AppBar(                    // display the widgets on top most in page or layout .
       ...
       title: Text("Music Player" , style: ourStyle(family: bold , size: 18),),
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context , int index) {
                    ...
                    return Container(
                      ...
                      margin: EdgeInsets.only(bottom: 8) ,   // give spacing between each and every tiles .

                      child: Obx(                         // obx ----> it can get the value of the observable variable; without Obx, the value would not get reflected.
                        () =>  ListTile(
                          ...
                          onTap: () {
                            ...
                            ) ;          // it helps to navigate the current page to player page .
